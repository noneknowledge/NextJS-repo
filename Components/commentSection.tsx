...
import { useAuth, useComment } from "@/app/customHook"
...
const CommentSection = ({gameId}:any) =>{
  ...
  <div className="max-w-2xl mx-auto px-4">
    ...
    <form className="mb-6" onSubmit={postComment}>
        ...
        <input name="gameid" value={gameId}/>
        </div>
        ...
        return (
            ...
            <footer className="flex justify-between items-center mb-2">
                <div className="flex items-center">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">{typeof comment.createAt}</p>
                </div>
